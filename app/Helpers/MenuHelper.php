...
class MenuHelper
{
    public static function getMainNavItemsSuperAdmin()
    {
        return [
            [
                'icon' => 'dashboard',
    ...
    public static function getMainNavItemsAdmin()
    {
        return [
            [
                'icon' => 'dashboard',
    ...
    public static function getMainNavItemsStaff()
    {
        return [
            [
                'icon' => 'dashboard',
    ...
    public static function getMenuGroupsAdmin()
    {
        return [
            [
                'title' => 'Menu',
    ...
    public static function getMenuGroupsStaff()
    {
        return [
            [
                'title' => 'Menu',
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'user' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 256"><path fill="#666666" d="M117.25 157.92a60 60 0 1 0-66.5 0a95.83 95.83 0 0 0-47.22 37.71a8 8 0 1 0 13.4 8.74a80 80 0 0 1 134.14 0a8 8 0 0 0 13.4-8.74a95.83 95.83 0 0 0-47.22-37.71M40 108a44 44 0 1 1 44 44a44.05 44.05 0 0 1-44-44m210.14 98.7a8 8 0 0 1-11.07-2.33A79.83 79.83 0 0 0 172 168a8 8 0 0 1 0-16a44 44 0 1 0-16.34-84.87a8 8 0 1 1-5.94-14.85a60 60 0 0 1 55.53 105.64a95.83 95.83 0 0 1 47.22 37.71a8 8 0 0 1-2.33 11.07"/></svg>',
            'pusat' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48 48"><g fill="none"><path stroke="#666666" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M4 42h40"/><rect width="8" height="16" x="8" y="26" stroke="#666666" stroke-linejoin="round" stroke-width="4" rx="2"/><path stroke="#666666" stroke-linecap="square" stroke-linejoin="round" stroke-width="4" d="M12 34h1"/><rect width="24" height="38" x="16" y="4" stroke="#666666" stroke-linejoin="round" stroke-width="4" rx="2"/><path fill="#666666" d="M22 10h4v4h-4zm8 0h4v4h-4zm-8 7h4v4h-4zm8 0h4v4h-4zm0 7h4v4h-4zm0 7h4v4h-4z"/></g></svg>',
            'logout' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#666666" d="m17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5M4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4z"/></svg>',
