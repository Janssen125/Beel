    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="/" class="xl:hidden">
                <img class="dark:hidden w-50" src="/images/logo/logo.png" alt="Logo" />
                <img class="hidden dark:block w-50" src="/images/logo/logo.png" alt="Logo" />
            </a>
            ...
            <!-- Search Bar (desktop only) no use-->
