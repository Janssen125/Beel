            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
                <div
                    ...
                    <div class="flex items-end justify-between mt-5">
                        <div>
                            <span class="text-sm text-gray-500 dark:text-gray-400">Staffs</span>
                            <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">{{ $totalUser }}
                            </h4>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-span-12">
            <div
                ...
                <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Transaksi Baru</h3>
                    </div>
                </div>
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="border-t border-gray-100 dark:border-gray-800">
                                ...
                                <th class="py-3 text-left">
                                    <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Nomor Meja</p>
                                </th>
                                <th class="py-3 text-left">
                                    <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Status</p>
                                </th>
                                <th class="py-3 text-left">
                                    <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Total Harga</p>
                                </th>
                                <th class="py-3 text-left">
                                    <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Waktu Transaksi
                                    </p>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            @if ($topTransaction->isEmpty())
                                <tr class="border-t border-gray-100 dark:border-gray-800">
                                    <td colspan="4" class="py-3 whitespace-nowrap text-center">
                            ...
                            @endif
                            @foreach ($topTransaction as $transaction)
                                <tr class="border-t border-gray-100 dark:border-gray-800">
