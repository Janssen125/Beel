@extends('layouts.app')
@section('title', 'Tambah Makanan / Minuman')
@section('content')
    <x-common.page-breadcrumb pageTitle="Tambah Makanan / Minuman" :breadcrumbs="[['label' => 'Daftar Makanan & Minuman', 'url' => route('fnbs.index')]]" />
    <div class="flex justify-center w-full">
        <div class="w-full sm:w-8/12">
            <x-common.component-card title="Tambah Makanan / Minuman">
                <form action="{{ route('fnbs.store') }}" method="POST" enctype="multipart/form-data" class="grid gap-6">
                    @csrf
                    <div>
